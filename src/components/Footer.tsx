      ...
      <div className="max-w-[1512px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a href="https://www.instagram.com/chanukajeewantha/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-text-body/20 flex items-center justify-center text-white hover:bg-[#E1306C] transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            <a href="https://www.tiktok.com/@chanukajeewantha" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full bg-text-body/20 flex items-center justify-center text-white hover:bg-white dark:bg-zinc-900 hover:text-black dark:text-white transition-colors">
