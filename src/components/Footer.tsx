        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li><Link href="/free-ats-cv-checklist" className="hover:text-brand-main transition-colors text-brand-main font-semibold">Free ATS CV Checklist</Link></li>
              <li><Link href="/free-linkedin-headline-formula" className="hover:text-brand-main transition-colors text-brand-main font-semibold">Free LinkedIn Headline Formula</Link></li>
              <li><Link href="/fiverr-orders" className="hover:text-brand-main transition-colors text-text-light/80">Fiverr Orders</Link></li>
              ...
              <li><Link href="/cv-writing-guides" className="hover:text-brand-main transition-colors text-text-light/80">100 CV Writing Guides</Link></li>
            </ul>
          </div>
