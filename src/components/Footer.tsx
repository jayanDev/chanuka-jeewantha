      ...
      <div className="max-w-[1512px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a href="https://www.tiktok.com/@chanukajeewantha" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full bg-text-body/20 flex items-center justify-center text-white hover:bg-white hover:text-black transition-colors">
