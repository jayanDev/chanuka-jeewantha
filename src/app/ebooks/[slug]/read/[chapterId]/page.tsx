          ...
          <div className="max-w-2xl mx-auto bg-gradient-to-br from-zinc-900 to-black rounded-3xl p-10 md:p-14 text-white shadow-2xl text-center relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-4 bg-brand-main text-foreground font-medium rounded-xl hover:bg-brand-dark transition-colors flex items-center justify-center gap-3 w-full sm:w-auto order-1 sm:order-2 shadow-gold"
              >
