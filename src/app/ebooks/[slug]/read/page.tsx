  ...
  return (
    <div className="min-h-screen bg-zinc-50">
        ...
        <div className="mx-auto max-w-3xl px-5 sm:px-6 pt-12 pb-10">
          <div className="flex flex-col sm:flex-row sm:items-end gap-6">
            <div className="flex-1">
              ...
              <h1 className="font-plus-jakarta text-3xl sm:text-4xl font-extrabold text-foreground leading-tight mb-3">
                {ebook.title}
              </h1>
      ...
      <div className="mx-auto max-w-3xl px-5 sm:px-6 py-10">
        <h2 className="font-plus-jakarta text-xl font-bold text-foreground mb-6">Table of Contents</h2>
        ...
        {!hasPremiumAccess && (
          <div className="mt-8 rounded-2xl border-2 border-dashed border-brand-main/30 bg-brand-main/5 p-8 text-center">
            ...
            <h3 className="font-plus-jakarta text-lg font-bold text-foreground mb-2">
              Unlock Full Access
            </h3>
