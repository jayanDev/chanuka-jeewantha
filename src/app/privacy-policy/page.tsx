...
export default function PrivacyPolicyPage() {
  return (
    <section className="w-full bg-zinc-50 dark:bg-zinc-900 py-[90px]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-8 space-y-6 rounded-[18px] border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 md:p-8">
          <article>
            <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900 dark:text-zinc-100">1. Information We Collect</h2>
          ...
          <article>
            <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900 dark:text-zinc-100">2. How We Use Information</h2>
            <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          ...
          <article>
            <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900 dark:text-zinc-100">3. Document Security</h2>
            <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          ...
          <article>
            <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900 dark:text-zinc-100">4. Third-Party Services</h2>
            <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          ...
          <article>
            <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900 dark:text-zinc-100">5. Cookies and Analytics</h2>
            <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          ...
          <article>
            <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900 dark:text-zinc-100">6. Your Rights</h2>
            <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          ...
          <article>
            <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900 dark:text-zinc-100">7. Contact</h2>
            <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link href="/terms-and-conditions" className="rounded-[10px] border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-5 py-2.5 text-sm font-semibold text-zinc-700 dark:text-zinc-300 hover:border-brand-main hover:text-brand-main transition-colors">Terms & Conditions</Link>
        </div>
      </div>
    </section>
  );
