...
const textFields: Array<{ key: string; label: string; required?: boolean; placeholder?: string }> = [
  ...
  { key: "referees", label: "Referees Details" },
  { key: "paymentRef", label: "Bank Transfer Reference" },
];

const longFields: Array<{ key: string; label: string; placeholder?: string }> = [
  {
    key: "workExperience",
          ...
          <div className="rounded-[18px] border border-zinc-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
              {serviceOptionChoices.map((item) => (
                <label key={item.key} className="flex cursor-pointer gap-3 rounded-[12px] border border-zinc-200 p-5 hover:border-brand-main">
                  <input
                    type="radio"
                    name="serviceOption"
          ...
          <div className="space-y-8">
            <div className="rounded-[18px] border border-zinc-200 bg-white p-6 shadow-sm md:p-8">
              <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
                ...
                <button type="button" onClick={() => setStep(1)} className="rounded-[10px] border border-zinc-300 px-4 py-2 text-sm font-semibold">
                  Change Answers
                </button>
              </div>
            ...
            <form onSubmit={submitOrder} className="rounded-[18px] border border-zinc-200 bg-white p-6 shadow-sm md:p-8">
              <h2 className="font-plus-jakarta text-[30px] font-bold text-foreground">Order this package</h2>
              <p className="mt-2 text-zinc-600">Complete the details below. Your order will be activated after payment is verified.</p>
              ...
              <div className="mt-8 rounded-[14px] border border-zinc-200 bg-zinc-50 p-5">
              ...
              <button
                ...
                className="mt-6 rounded-[10px] bg-brand-main px-6 py-3 font-semibold text-white hover:bg-brand-dark disabled:opacity-60"
              >
