...
export default function TermsAndConditionsPage() {
 ...
 <div className="mt-8 space-y-6 rounded-[18px] border border-zinc-200 bg-zinc-50 p-6 md:p-8">
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Use of the Website</h2>
          ...
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Product Information and Pricing</h2>
            <ul className="mt-2 list-[lower-alpha] pl-5 text-sm leading-relaxed text-zinc-600 space-y-1">
          ...
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Orders and Payments</h2>
            <ul className="mt-2 list-[lower-alpha] pl-5 text-sm leading-relaxed text-zinc-600 space-y-1">
          ...
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Shipping and Delivery</h2>
            <ul className="mt-2 list-[lower-alpha] pl-5 text-sm leading-relaxed text-zinc-600 space-y-1">
          ...
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Returns and Refunds</h2>
            <ul className="mt-2 list-[lower-alpha] pl-5 text-sm leading-relaxed text-zinc-600 space-y-1">
          ...
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Intellectual Property</h2>
            <ul className="mt-2 list-[lower-alpha] pl-5 text-sm leading-relaxed text-zinc-600 space-y-1">
          ...
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Limitation of Liability</h2>
            <ul className="mt-2 list-[lower-alpha] pl-5 text-sm leading-relaxed text-zinc-600 space-y-1">
          ...
          <article>
 <h2 className="text-[22px] font-bold font-plus-jakarta text-zinc-900">Amendments and Termination</h2>
