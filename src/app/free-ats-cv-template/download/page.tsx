...
export const metadata: Metadata = buildPageMetadata({
  title: "Download Your Free ATS CV Format | Chanuka Jeewantha",
  description:
    "Your free ATS-friendly professional CV format in Word is ready to download. No signup required.",
  path: "/free-ats-cv-template/download",
...
export default function FreeCvTemplateDownloadPage() {
  return (
    <section className="w-full bg-bg-cream px-4 py-12 sm:px-6 md:py-16">
      <div className="mx-auto max-w-2xl">
        <div className="mb-6 flex items-center gap-2 text-sm font-medium text-text-secondary">
          <Link href="/free-ats-cv-template" className="hover:text-brand-main">
            Free CV Format
          </Link>
