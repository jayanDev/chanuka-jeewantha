...
export default function HelpPage() {
 ...
 <section className="w-full border-b border-zinc-200 bg-zinc-50 py-[90px]">
        <div className="max-w-[1512px] mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="font-heading text-[30px] sm:text-[42px] md:text-[56px] font-bold text-foreground leading-[1.1] mb-5">
 ...
 <section className="w-full py-[72px] bg-white">
        <div className="max-w-[1512px] mx-auto px-4 sm:px-6">
          <div className="mb-8 flex items-end justify-between gap-4">
            <h2 className="text-[30px] md:text-[40px] font-bold font-heading text-foreground">Quick Help Topics</h2>
 ...
 <h3 className="text-[18px] font-bold font-heading text-zinc-900 mb-2">{topic.title}</h3>
 ...
 <section className="w-full border-t border-zinc-200 bg-zinc-50 py-[72px]">
        <div className="max-w-[1512px] mx-auto px-4 sm:px-6">
          <h2 className="text-[30px] md:text-[40px] font-bold font-heading text-foreground mb-8">Payment Instructions</h2>
 ...
 <section className="w-full border-t border-zinc-200 bg-white py-[72px]">
        <div className="max-w-[1512px] mx-auto px-4 sm:px-6">
          <h2 className="text-[30px] md:text-[40px] font-bold font-heading text-foreground mb-8">All Packages and Delivery Details</h2>
          <div className="space-y-8">
            {packageCategories.map((category) => (
 <article key={category.key} className="rounded-[20px] border border-zinc-200 bg-zinc-50 p-5 md:p-7">
 <h3 className="text-[24px] font-bold font-heading text-zinc-900 mb-2">{category.title}</h3>
 ...
 <h4 className="text-[18px] font-bold font-heading text-zinc-900">{pkg.name}</h4>
 ...
 <section className="w-full border-t border-zinc-200 bg-zinc-50 py-[72px]">
        <div className="max-w-[1512px] mx-auto px-4 sm:px-6">
          <h2 className="text-[30px] md:text-[40px] font-bold font-heading text-foreground mb-6">Need More Help?</h2>
