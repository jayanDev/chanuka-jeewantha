...
export async function generateMetadata({ params }: ChecklistPageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    path: `/resources/checklists/${slug}`,
    keywords: [checklist.title, "free checklist", "business startup", "career resources"],
  });
}
      ...
      <section className="w-full bg-foreground text-background pt-[116px] md:pt-[170px] pb-[72px] md:pb-[90px]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-10 items-start">
            {/* Cover image */}
            <div className="relative aspect-[4/3] overflow-hidden rounded-[20px] border border-white/15 bg-zinc-800 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-600" aria-hidden="true"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
              {/* Replace with: <Image src={checklist.coverImage} alt={checklist.title} fill className="object-cover" /> */}
            </div>
